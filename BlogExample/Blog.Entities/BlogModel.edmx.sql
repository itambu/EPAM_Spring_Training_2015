...
-- --------------------------------------------------
-- Date Created: 05/12/2017 19:31:14
-- Generated from EDMX file: D:\EPMTrainingExamples\EPAM_Spring_Training_2015\BlogExample\Blog.Entities\BlogModel.edmx
-- --------------------------------------------------
...
CREATE TABLE [dbo].[Users] (
    ...
    [Contact_FacebookId] nvarchar(max)  NOT NULL
);
GO
